...
public class ExceptionManagerService {
  ...
  static {
    EXCEPTION_STATUS_MAP.put(ProductoNoEncontradoException.class, HttpStatus.NOT_FOUND);
    EXCEPTION_STATUS_MAP.put(StockInsuficienteException.class, HttpStatus.BAD_REQUEST);
  }
